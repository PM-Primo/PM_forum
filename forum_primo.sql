...
-- Listage des données de la table forum_primo.post : ~6 rows (environ)
...
INSERT INTO `post` (`id_post`, `datePost`, `textePost`, `topic_id`, `user_id`) VALUES
	...
	(5, '2022-11-04 16:45:53', 'Bonsoir, j\'ai eu le même problème mais avec du orange, est-ce qu\'il n\'y aurait pas un crayon de couleur coincé dans ton imprimante ?', 2, 2),
	(6, '2022-11-04 16:53:19', 'Effectivement c\'était ça !\r\nTout fonctionne à merveille !\r\nMerci beaucoup !', 2, 1),
	(8, '2022-11-09 10:49:02', 'bloublou', 5, 3),
	(9, '2022-11-09 14:19:15', 'En vrai la quiche aux poireaux c\'est délicieux', 4, 3);
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `roleUser` varchar(50) NOT NULL DEFAULT 'Utilisateur',
  PRIMARY KEY (`id_user`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;

-- Listage des données de la table forum_primo.user : ~2 rows (environ)
...
INSERT INTO `user` (`id_user`, `emailUser`, `mdpUser`, `pseudoUser`, `roleUser`) VALUES
	...
	(3, 'pierrem.primo@gmail.com', '$2y$10$R.K9VvhmLp9pXDpJ9HOkoeYcte1ZI0tHFC6XQmE4k3oBXIhZf2OCe', 'PM Primo', 'Utilisateur'),
	(4, 'bubu@gmail.com', '$2y$10$2iwU/FoVZ.SjTnNIpixfte62lKFfo5q6hWI/IOgyzPXaaafzUF0RW', 'Bubu', 'Admin');
